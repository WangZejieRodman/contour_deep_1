...
def main():
    ...
    try:
        ...
        os.makedirs('/home/wzj/pan1/contour_deep_1/scripts/logs/day9_evaluation', exist_ok=True)
        with open('/home/wzj/pan1/contour_deep_1/scripts/logs/day9_evaluation/train_self_query.json', 'w') as f:
            json.dump(results, f, indent=2)

        print(f"\n结果已保存: /home/wzj/pan1/contour_deep_1/scripts/logs/day9_evaluation/train_self_query.json")
